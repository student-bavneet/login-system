...
{
  echo "<script>window.location.href='btw_dates_report.php';</script>";
}
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> B/w Dates Report </h3>
            ...
            <div class="row">
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post">
                      <div class="form-group row">
                        <label for="exampleInputMobile" class="col-sm-3 col-form-label">From Date</label>
                        <div class="col-sm-9">
                          <input type="date" name="from_date" class="form-control" id="exampleInputMobile" placeholder="Mobile number">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="exampleInputMobile" class="col-sm-3 col-form-label">To Date</label>
                        <div class="col-sm-9">
                          <input type="date" name="to_date" class="form-control" id="exampleInputMobile" placeholder="Mobile number">
                        </div>
                      </div>
                      <button type="submit" name="date" class="btn btn-primary mr-2">Submit</button>
              ...
              <?php
                ...
                {
                    extract($_POST);
                    $sql="SELECT * FROM users WHERE date(posting_date) BETWEEN '$from_date' and '$to_date'";
