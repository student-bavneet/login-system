...
if(isset($_POST['search']))
  {
    extract($_POST);
    $sql="SELECT * FROM users WHERE(fname='$srch_res' or lname='$srch_res' or email='$srch_res' or contact_no='$srch_res')";
          ...
          <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
            ...
            <ul class="navbar-nav w-100 pt-3">
              <li class="nav-item w-100">
                <form class="nav-link mt-2 mt-md-0 d-none d-lg-flex search" action="search_results.php" method="post">
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  ...
                  <?php
                    if(isset($_POST['search']))
                      {
                        echo "<h4>Search results against keyword '".$srch_res."'</h4>";
                  ?>
